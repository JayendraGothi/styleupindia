                                        ...
                                        <table width="600" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    This is to notify you that order <?php echo $order->order_id ?> placed on <?php echo $order->date ?> from <?php echo $order->merchant ?> with amount <?php echo $order->amount ?> via StyleUpIndia has been moved to the following status :
                                                </td>
                                            </tr>
                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td height="38"
                                                                    ...
                                                                    <a href="http://email.pinterest.com/mpss/c/1wA/2dUJAA/t.1jy/iSspk3TWSXy88RDX5MxrFQ/h4/i41K-2FvbQBVKuIVW29rFpYjhalycjBBC0Vi21R4HxfyrVh357w8EAe-2FU2RAIlph8-2Bzzg8tK6UwlwxtId7RdeVvNltgC0iNoussBPBxEpZieKOK3MbaDIWgkAupxArWnmqBRv5imYzYoMC34aoKuVDWwCxMcs1GmysuhM-2B9fT-2FlQZdOTtM9-2FhWkaF9DwSmP5Nv"
                                                                       ...
                                                                       target="_blank">
                                                                        <?php echo str_status($order->status) ?>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                            </tbody>
